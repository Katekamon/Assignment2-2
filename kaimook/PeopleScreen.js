        ...
        return (
            <Root>
                <View style={styles.listScreenContainer}>
                    <CustomButton text="Add People" width="94%"
                                                    ...
                                                    text: "Yes", onPress: () => {
                                                        AsyncStorage.getItem("people",
                                                            function (inError, inPeople) {
                                                                ...
                                                                AsyncStorage.setItem("rpeople",
                                                                    JSON.stringify(inPeople), function () {
                                                                        this.setState({ listData: inPeople });
                                                                        Toast.show({
                                                                            text: "RPeople deleted",
                                                                            position: "bottom", type: "danger", duration: 2000
                                                                        });
                                                                    }.bind(this)
                                                                );
                                                            }.bind(this)
            ...
            <ScrollView style={styles.addScreenContainer}>
                ...
                <View style={styles.addScreenInnerContainer}>
                    <View style={styles.addScreenFormContainer}>
                        ...
                        <CustomTextInput label="Phone Number" maxLength={20} stateHolder={this}
                            stateFieldName="phoneNumber" />
                        <CustomTextInput label="Address" maxLength={20} stateHolder={this}
                            stateFieldName="address" />
                        <CustomTextInput label="Web Site" maxLength={20} stateHolder={this}
...
const styles = StyleSheet.create({
    ...
    peopleList: { width: "94%" },
    peopleContainer: { flexDirection: "row", marginTop: 4, marginBottom: 4, borderColor: "#e0e0e0", borderBottomWidth: 2, alignItems: "center" },
    peopleName: { flex: 1 },
